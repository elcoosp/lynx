...
TEST_P(ElementTemplateInstanceTest, UsesIndependentLepusRefType) {
  ...
  EXPECT_EQ(instance->GetRefType(), lepus::RefType::kOtherType);
...
TEST_P(ElementTemplateInstanceTest,
  ...
  ASSERT_EQ(child.RefCounted()->GetRefType(), lepus::RefType::kOtherType);
  ...
  ASSERT_EQ(parent.RefCounted()->GetRefType(), lepus::RefType::kOtherType);
