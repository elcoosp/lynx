...
public class LynxRecorderReplayDataModule extends LynxContextModule {
  ...
  private String extractProtocolCallbackId(ReadableArray args) {
    ...
    return normalizeCallbackId(callbackId);
  }
  ...
  private boolean isSameCallbackId(String expectedCallbackId, Object actualCallbackId) {
    ...
    String normalizedActualCallbackId = normalizeCallbackId(actualCallbackId);
    return expectedCallbackId.equals(normalizedActualCallbackId);
  }
