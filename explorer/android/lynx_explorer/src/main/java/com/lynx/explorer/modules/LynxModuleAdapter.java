...
public class LynxModuleAdapter {
  ...
  public void Init(Context context) {
    ...
    LynxEnv.inst().registerModule("FileSystemModule", FileSystemModule.class);
    LynxEnv.inst().registerModule("ConstantsModule", ConstantsModule.class);
    LynxEnv.inst().registerModule("FontModule", FontModule.class);
    LynxEnv.inst().registerModule("LocationModule", LocationModule.class);
    LynxEnv.inst().registerModule("MediaLibraryModule", MediaLibraryModule.class);
    LynxEnv.inst().registerModule("ContactsModule", ContactsModule.class);
    LynxEnv.inst().registerModule("SpeechModule", SpeechModule.class);
    LynxEnv.inst().registerModule("WebBrowserModule", WebBrowserModule.class);
    LynxEnv.inst().registerModule("SqliteModule", SqliteModule.class);
    LynxEnv.inst().registerModule("CameraModule", CameraModule.class);
    LynxEnv.inst().registerModule("NotificationsModule", NotificationsModule.class);
    LynxEnv.inst().registerModule("Image", Image.class);
