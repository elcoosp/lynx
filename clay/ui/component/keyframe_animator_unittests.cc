...
TEST_F_UI(KeyFrameTest,
  ...
  struct CallbackCleanup {
    ...
    ~CallbackCleanup() {
      handler->SetAnimationCallback(nullptr);
      handler->SetCurrentTimeCallback(nullptr);
    }
...
TEST_F_UI(KeyFrameTest,
  ...
  struct CallbackCleanup {
    AnimationHandler* handler;
    ~CallbackCleanup() { handler->SetCurrentTimeCallback(nullptr); }
  } callback_cleanup{handler};
